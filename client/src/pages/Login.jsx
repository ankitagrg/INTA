    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f0f4ff] to-[#f8f9ff] flex flex-col items-center justify-between py-10 px-4 font-sans selection:bg-violet-100 selection:text-violet-900">
      ...
      <div className="flex flex-col items-center space-y-3 mt-4">
        ...
        <div className="text-center space-y-1.5">
          <h1 className="text-3xl font-bold text-[#0e1628] tracking-tight">Welcome back</h1>
      ...
      <div className="w-full max-w-[440px] bg-white rounded-[32px] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100/80 my-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Password Header (Label + Forgot) */}
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label className="text-xs font-semibold text-slate-700 tracking-wide uppercase">
                Password
              </label>
              <Link to="#" className="text-xs text-[#7c3aed] hover:underline font-semibold">
                Forgot?
              </Link>
            </div>
          ...
          <div className="flex items-center space-x-2.5">
            <input
              ...
              className="w-4.5 h-4.5 rounded border-slate-300 text-violet-600 focus:ring-violet-500/20"
            />
            <label htmlFor="remember" className="text-sm font-medium text-slate-500 select-none">
              Remember me
            </label>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#0e1628] hover:bg-[#1a253c] text-white py-4 rounded-2xl flex justify-center items-center gap-2 font-semibold shadow-[0_4px_12px_rgba(14,22,40,0.12)] hover:shadow-[0_6px_20px_rgba(14,22,40,0.18)] transition-all disabled:opacity-50 disabled:pointer-events-none"
          >
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            type="button"
            className="flex items-center justify-center py-3 border border-slate-200/80 rounded-2xl bg-white hover:bg-slate-50 hover:border-slate-300 font-medium text-slate-600 text-sm transition"
          >
          ...
          >
            <svg className="w-5 h-5 text-slate-800" viewBox="0 0 24 24" fill="currentColor">
              <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.166 6.839 9.489c.5.092.682-.217.682-.482c0-.237-.008-.866-.013-1.7c-2.782.603-3.369-1.34-3.369-1.34c-.454-1.156-1.11-1.464-1.11-1.464c-.908-.62.069-.608.069-.608c1.003.07 1.531 1.032 1.531 1.032c.892 1.53 2.341 1.088 2.91.832c.092-.647.35-1.088.636-1.338c-2.22-.253-4.555-1.11-4.555-4.943c0-1.091.39-1.984 1.029-2.683c-.103-.253-.446-1.27.098-2.647c0 0 .84-.269 2.75 1.025A9.564 9.564 0 0 1 12 6.844c.85.004 1.705.115 2.504.337c1.909-1.294 2.747-1.025 2.747-1.025c.546 1.377.203 2.394.1 2.646c.64.699 1.026 1.592 1.026 2.683c0 3.842-2.337 4.687-4.565 4.935c.359.309.678.919.678 1.852c0 1.336-.012 2.415-.012 2.743c0 .267.18.579.688.481C19.137 20.162 22 16.418 22 12c0-5.523-4.477-10-10-10z" />
            </svg>
          </button>
          <button
            type="button"
      ...
      <div className="flex flex-col items-center space-y-6 mb-4 w-full">
        ...
        <button
          type="button"
          className="flex items-center space-x-2 text-[10px] font-bold tracking-wider text-slate-400/80 hover:text-slate-600 transition uppercase"
        >
